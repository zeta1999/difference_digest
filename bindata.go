...
func difference_digestSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "difference_digest.sql", size: 1449, mode: os.FileMode(420), modTime: time.Unix(1599447694, 0)}
